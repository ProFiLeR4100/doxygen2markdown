...
program
    ...
    .option('-d, --doxygen <type>', 'Doxygen XML output directory')
    .option('-o, --output <type>', 'Converter output directory.')
    .option('-t, --templates <type>', 'Custom templates directory')
    .parse(process.argv);
...
if (program.doxygen && program.output) {
    ...
    console.log(program.doxygen, program.output, program.templates);
    // path.isAbsolute
